...
(function(window, $) {
  ...
  IncorrectWordsBox.prototype.bindEvents = function() {
    this.container.bind('click', 'a', selectWordHandler.call(this, 'select.word'));
  ...
  SuggestBox.prototype.bindEvents = function() {
    ...
    this.container.bind(click, this.onContainerClick.bind(this));
    this.container.bind(click, '.ignore-word', selectWordHandler.call(this, 'ignore.word'));
    this.container.bind(click, '.ignore-all', this.handler('ignore.all'));
    this.container.bind(click, '.ignore-forever', this.handler('ignore.forever'));
    this.container.bind(click, '.words a', selectWordHandler.call(this, 'select.word'));
    $('html').bind(click, this.onWindowClick.bind(this));
